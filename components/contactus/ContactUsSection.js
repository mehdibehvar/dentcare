...
<Grid item xs={12} md={6}>
   ...
   <Paper elevation={12}  square >
    <Box sx={{padding:2}}>
    <Typography variant="h6" component={"div"}> با ما در تماس باشید...</Typography>
    <Typography variant="caption" component={"p"}>راههای ارتباطی با ما به صورت تمام وقت در خدمت رسانی به شما است.</Typography>
    </Box>
      <InTouchList/>
       </Paper>
   </Box>
